...
router.post('/update-avatar',authMiddleware.isAuth,controller.updateImage); //6/Add Or Update Avatar
router.post('/delete-avatar',authMiddleware.isAuth,controller.deleteImage);
